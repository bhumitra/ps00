...
(check-expect (sum-two-larger 1 2 3) 5)
(check-expect (sum-two-larger 1 3 2) 5)
(check-expect (sum-two-larger 3 2 1) 5)
(check-expect (sum-two-larger 3 1 2) 5)
(check-expect (sum-two-larger 2 1 3) 5)
(check-expect (sum-two-larger 2 3 1) 5)
(check-expect (sum-two-larger 15 5 15) 30)
(check-expect (sum-two-larger -4 2 4) 6)
(check-expect (sum-two-larger 11 11 2) 22)
(check-expect (sum-two-larger 11 11 11) 22)
(check-expect (sum-two-larger -2 -2 -2) -4)
